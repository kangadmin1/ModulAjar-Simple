    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in-up">
      ...
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-100">
        ...
        <div className="pt-20 pb-10 px-6 text-center">
          <h2 className="text-2xl font-bold text-slate-800">Faisal Rohman, S.Pd.</h2>
          <p className="text-brand-600 font-medium mt-1">Guru Matematika - Dev</p>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 text-left max-w-2xl mx-auto">
            ...
            <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-slate-800 font-medium">MTs NU TBS KUDUS</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-slate-800 font-medium">Guru / Administrator</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-lg md:col-span-2">
              ...
              <div>
                <p className="text-xs text-slate-500 font-bold uppercase tracking-wider">Youtube Channel</p>
                <p className="text-slate-800 font-medium">https://youtube.com/@hanyauntukmu</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-lg md:col-span-2">
              ...
              <div>
                ...
                <p className="text-slate-800 font-medium">faisalrohman@gmail.com</p>
              </div>
            </div>
      ...
      <div className="bg-gradient-to-br from-indigo-900 to-brand-900 rounded-2xl p-8 md:p-12 text-white relative overflow-hidden shadow-2xl">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto space-y-6">
          ...
          <h3 className="text-2xl md:text-3xl font-serif italic leading-relaxed">
            "Teknologi hadir bukan untuk menggantikan peran pendidik, melainkan untuk membantu dari belenggu administrasi, sehingga hati dan pikiran guru dapat sepenuhnya tercurah untuk menyalakan api keingintahuan siswa."
          </h3>
          <div className="w-16 h-1 bg-brand-400 mx-auto rounded-full"></div>
          <p className="text-brand-200 text-sm">@hanyauntukmu</p>
        </div>
      </div>
    </div>
  );
